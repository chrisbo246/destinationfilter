...
console.time('enabledPrioritiesController.js script loaded');
...
// initBlock('[data-anchor="enabled_priorities"]');
...
deferred.ready.enabledPriorities.resolve();

console.timeEnd('enabledPrioritiesController.js script loaded');
