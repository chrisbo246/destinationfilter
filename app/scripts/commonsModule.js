...
var commonsModule = (function () {
    ...
    modules.debug = function (settings) {
        ...
        if (!settings.debug) {
            ...
            settings.disabledLogs.forEach(function (element, index, array) {
        ...
        // All inputs
        var el = $(':input').on('input change click'
                + ' chosen:updated chosen:maxselected'
