...
var mapLayersModule = (function () {
    ...
    */
     ...
     */
    var GPXFileSource = function GPXFileSource(selector, layer) {
     ...
     */
    var _formatBytes = function _formatBytes(bytes, decimals) {
