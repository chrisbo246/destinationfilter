...
var geolocationModule = (function () {
    ...
    var telizecomGeoip = function telizecomGeoip() {
    ...
    var freegeoipnetGeoip = function freegeoipnetGeoip() {
    ...
    var _getCenterWithHeading = function _getCenterWithHeading(position, rotation, resolution) {
    ...
    var _addPosition = function _addPosition(position, heading, m, speed) {
    ...
    var _updateUserAddress = function _updateUserAddress() {
        // lon, lat
    ...
    $.when(appModule.deferred.ready.map).then(function () {
        // , appModule.deferred.load.mapSettings
        ...
        $(function () {
            ...
            $('#track').on('switchChange.bootstrapSwitch init', function () {
                // e, state
            ...
            if ($el) {
                $el.on('switchChange.bootstrapSwitch', function () {
                    // e, state
                    if (this.checked) {
