...
var geolocationModule = (function () {
    ...
    var telizecomGeoip = function () {
        ...
        return $.getJSON('http://www.telize.com/geoip', function (result) { 
            if (result.country_code) {
                ...
                $.when(deferred.ready.userProfile).done(function () {
    ...
    $.when(deferred.ready.map).then(function () { // , deferred.load.mapSettings
        ...
        $(function () {
            ...
            geolocation.on('change', function () {
                ...
                $.when(deferred.load.mapSettings).then(function () {
