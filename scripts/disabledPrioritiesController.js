...
var disabledPrioritiesModule = (function () {
    ...
    $(function () {
        ...
        $.get('modules/disabledPriorities/disabledPrioritiesModal.hbs', function (source) {
            ...
            $.getJSON('modules/disabledPriorities/disabledPrioritiesModal.json', function (json) {
                var viewData,
                    // rendered,
                    filters = [];
                ...
                prioritiesData = json;
                deferred.getJSON.prioritiesData.resolve();
            });
        */
                /*
                ...
                */
                ...
                $.when(deferred.ready.enabledPriorities).done(function () {
